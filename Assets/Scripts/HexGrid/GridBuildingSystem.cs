...
namespace Grid{
    public class GridBuildingSystem : MonoBehaviour {
        ...
        private GridXZ<GridObject> gridA, gridB, gridC, gridD, gridE, gridF, gridG, gridH;
        ...
        private void Awake(){
            ...
            gridA = new GridXZ<GridObject>(gridWidth, gridHeight, cellSize, new Vector3(0 ,0 ,0 ), (GridXZ<GridObject> g, int x, int z) => new GridObject(g, x, z));
            ...
            for(int x = 0; x < gridWidth; x++){
                for(int z = 0; z < gridHeight; z++){
                    Instantiate(testBuilding, gridA.GetWorldPosition(x, z), Quaternion.identity);
                }
